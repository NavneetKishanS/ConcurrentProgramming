public class ThreadCreationExample {
     ...
     * Leveraging methods from the {@link DemoBasicThreadingHelper} class,
    ...
    public void start(){
        ...
        DemoBasicThreadingHelper.printSomethingElsex100();
    }
    ...
    private void runAnonymClass(){
        new Thread(){
            ...
            public void run() {
                ...
                DemoBasicThreadingHelper.printHellox100();
            }
        }.start();
    }
     ...
     * method reference operator (class::method) with DemoBasicThreadingHelper's
     * printHellox100, since it needs 0 parameters and returns with void
     *
     */
    private void runMethodReference(){
        Thread thread = new Thread(DemoBasicThreadingHelper::printHellox100);
        thread.start();
    }
    ...
    private void runWithRunnableAsLambda(){
        Runnable task = () -> DemoBasicThreadingHelper.printHellox100();
